 ...
 * @author ovmkas
 * @data 2024-01-18
 * @description 일지 글번호를 위한 스키마
 */
const diaryCounterSchema = new mongoose.Schema({
    _id: { type: String, required: true },
    sequence_value: { type: Number, default: 0 },
});

const diaryCounters = mongoose.model('diaryCounters', diaryCounterSchema);

module.exports = { mongoose, diaryCounters };